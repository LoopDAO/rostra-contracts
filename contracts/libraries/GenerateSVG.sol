...
library GenerateSVG {
  ...
  function generateSVGImage(ConstructNFTParams memory params) internal pure returns (string memory svg) {
    NFTSVG.SVGParams memory svgParams = NFTSVG.SVGParams({
      ...
      x1: scale(getCircleCoord(uint160(Address.parseAddr(params.creator)), 16, params.tokenId), 0, 255, 16, 274),
      y1: scale(getCircleCoord(uint160(Address.parseAddr(params.owner)), 16, params.tokenId), 0, 255, 100, 484),
      x2: scale(getCircleCoord(uint160(Address.parseAddr(params.creator)), 32, params.tokenId), 0, 255, 16, 274),
      y2: scale(getCircleCoord(uint160(Address.parseAddr(params.owner)), 32, params.tokenId), 0, 255, 100, 484),
      x3: scale(getCircleCoord(uint160(Address.parseAddr(params.creator)), 48, params.tokenId), 0, 255, 16, 274),
      y3: scale(getCircleCoord(uint160(Address.parseAddr(params.owner)), 48, params.tokenId), 0, 255, 100, 484)
    });
