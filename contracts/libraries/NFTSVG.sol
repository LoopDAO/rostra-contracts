...
library NFTSVG {
            ...
            string(
                abi.encodePacked(
                    ...
                    generateSVGRareSparkle(
                        params.tokenId,
                        address(Address.parseAddr(params.ownerAddr))
                    ),
                    "</svg>"
                )
            );
    ...
    function generateSVGBorderText(
        ...
        string memory str2 = string(
            abi.encodePacked(creatorAddr, unicode" • ", creatorName)
        );
    ...
    function generateSVGPositionDataAndLocationCurve(
        ...
        string memory lenstr2 = string(
            abi.encodePacked(
                ...
                (7 * ((bytes(priceString(price)).length + 10) + 4) + 4)
                    .toString()
            )
        );
        ...
        string memory lenstr3 = string(
            abi.encodePacked(
                ...
                (7 * ((bytes(priceString(limit)).length + 10) + 4) + 4)
                    .toString()
            )
        );
    ...
    function rangeLocation(uint256 tickLower, uint256 tickUpper)
        internal
        pure
