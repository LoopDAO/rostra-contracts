...
contract HappyRedPacket is Initializable {
        ...
        public returns (uint claimed) 
    {
        ...
        if (token_type == 0)
            ...
            transferToken(address(uint160(unbox(packed.packed2, 64, 160))), recipient, claimed_tokens);
        // Claim success event
    ...
    **/
    ...
    function transferToken(address token_address, address recipient_address, uint amount) internal{
